...
import BottomBar from "./Components/NavBar/Navbar_BottomBar";
    ...
    <Router>
      <div className="App">
        <Routes>
          ...
          <Route key="6" exact path="/direct/inbox" element={<MessengerPage />} />
          <Route key="7" exact path="/direct/t/:id" element={<MessengerPage />} />
        </Routes>
        <BottomBar/>
      </div>
    </Router>
