      ...
      <div className={styles.navbar}>
        <div className={styles.main_container}>
          <div className={`${styles.icon} ${styles.small_screen}`}>
            <svg aria-label="New Story" className="_ab6-" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24">
          ...
          <div className="search">
            <span className={styles.search_icon}>
              <svg aria-label="Search" className="_ab6-" color="#8e8e8e" fill="#8e8e8e" height="16" role="img" viewBox="0 0 24 24" width="16">
          ...
          <div className={styles.icon_container}>
            ...
            <div className={`${styles.icon} ${styles.alwaysVisible}`} onClick={() => navigate("/direct/inbox")}>
