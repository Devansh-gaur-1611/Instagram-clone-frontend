...
const StatusBar = () => {
  ...
  useEffect(() => {
    ...
    GetAuthRequest("api/status/fetch", SuccessFxn, enqueueSnackbar, navigate, setLoading);
  }, []);
  ...
  const createStatus = (e) => {
    ...
    uploadFiles(e.target.files[0], successFxn, enqueueSnackbar, navigate, setLoading);
  };
      ...
      <div>
        <div className="statusbar_container">
          <div className="status">
            ...
            <Avatar
              className="statusbar_status_create"
              onClick={() => {
                input.current.click();
              }}
            >
